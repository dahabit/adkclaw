...
export class ContextEngine {
  ...
  bootstrap(): BootstrapResult {
    ...
    // by aggregate mtime fingerprint. From level_2/codelab.md §2.
    throw new Error('REPLACE-CONTEXT-ENGINE not implemented — see level_2/codelab.md §2');
  }
  ...
  private fingerprint(): string {
    //REPLACE-CONTEXT-ENGINE
    // Aggregate mtime stamp of every file/dir bootstrap reads. From level_2/codelab.md §2.
    throw new Error('REPLACE-CONTEXT-ENGINE not implemented — see level_2/codelab.md §2');
  }

  private indexBank(): string | null {
    //REPLACE-CONTEXT-ENGINE
    // Sample the bank into a compact index for the system prompt. From level_2/codelab.md §2.
    throw new Error('REPLACE-CONTEXT-ENGINE not implemented — see level_2/codelab.md §2');
  }

  private loadSkills(): string | null {
    //REPLACE-CONTEXT-ENGINE
    // Sample workspace/skills/ into a system-prompt slice. From level_2/codelab.md §2.
    throw new Error('REPLACE-CONTEXT-ENGINE not implemented — see level_2/codelab.md §2');
  }
}
